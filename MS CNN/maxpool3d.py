...
def max_pool_3d(input, ds, ignore_border=False, st = None):
    """
    ...
    op = DownsampleFactorMax((ds[1],ds[2]), ignore_border, (st[1],st[2]))
    output = op(input_4D)
    ...
    op = DownsampleFactorMax((1,ds[0]), ignore_border,(1,st[0]))
